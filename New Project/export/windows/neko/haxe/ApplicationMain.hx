...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("PutoElQueLee", "NewProject", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "New Project", null, { width: 512, height: 480 });
